            ...
            <el-table-column label="操作" width="100">
                ...
                <template #default="{ row }">
                    <el-button :icon="Edit" circle plain type="primary" @click="showDialog(row)"
                        title="编辑分类"></el-button>
                    <el-button :icon="Delete" circle plain type="danger" @click="deleteCategory(row)" title="删除分类">
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-dialog v-model="dialogVisible" :title="title" width="30%">
            <el-form :model="categoryModel" :rules="rules" label-width="100px" style="padding-right: 30px">
                ...
                <el-form-item label="使用次数" prop="categoryCount">
                    <el-input v-model="categoryModel.categoryCount" minlength="1" maxlength="15"></el-input>
                </el-form-item>
            </el-form>
